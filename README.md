...
- [7 天急救计划](/Users/wizout/op/interview/practice/drills/7-day-rescue-plan.md)
...
- [AI Infra Mock](/Users/wizout/op/interview/practice/mock-interviews/ai-infra.md)
...
1. 先看 [Start Here](/Users/wizout/op/interview/docs/START-HERE.md)
2. 再选岗位入口或路线入口
3. 然后从对应领域的 `专题首页 -> 核心题清单 -> 代表题清单 -> 14 天计划 -> 压测包` 开始

### 如果你只剩 1 周

1. 跑 [7 天急救计划](/Users/wizout/op/interview/practice/drills/7-day-rescue-plan.md)
2. 跑对应领域的 `口述速答包`
3. 跑 [追问压测包](/Users/wizout/op/interview/practice/drills/follow-up-pressure-pack.md)
4. 用 [评分卡](/Users/wizout/op/interview/practice/mock-interviews/scorecard.md) 打分

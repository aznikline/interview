...
3. 你的主方向专题首页
4. 对应方向的核心题清单
5. [Final Review Checklist](/Users/wizout/op/interview/tracks/interview-university/final-review.md)
...
5. [Interview University 学习计划](/Users/wizout/op/interview/tracks/interview-university/README.md) 的阶段 2-4

## 如果你是 AI Infra / AI 编译器
...
- 把它当资料站，而不是课程
- 看完 `topics` 不去刷 `questions`
- 不做 mock，不做口述
- 不维护自己的弱项和 final review 清单
